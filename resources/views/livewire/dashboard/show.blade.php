...
@endif
    ...
    @include('livewire.dashboard.partials.confirm-modal')
    @include('livewire.dashboard.partials.location-verification-popup')
    @include('livewire.dashboard.partials.playlist-picker-modal')
</div>
